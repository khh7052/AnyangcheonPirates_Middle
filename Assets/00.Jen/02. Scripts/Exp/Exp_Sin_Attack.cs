...
public class Exp_Sin_Attack : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        // 공격 시작 코루틴
        StartCoroutine(SinAttackRoutine());
    ...
    void SpawnAttack()
    {
        if (sinAttackPrefab != null && attackPoint != null)
        {
            GameObject attackInstance = Instantiate(sinAttackPrefab, attackPoint.transform.position, Quaternion.identity);
