...
### 프로젝트 규모
- **총 스크립트**: 201개 C# 스크립트
- **구현**: 15개 스크립트 (핵심 전투 시스템)
- **씬**: 15개 (타이틀, 10개 스테이지, UI, 테스트 씬)
- **프로젝트 파일**: 총 11,153개 파일

### 폴더 구조
```
Assets/
├── 00.Jen/              // 작업 (15개 스크립트) ⭐
├── 00.Hanul/            // 팀원 Hanul 작업 (8개 스크립트)
├── 00.Hye/              // 팀원 Hye 작업 (12개 스크립트)
├── 01.Scenes/           // 게임 씬 파일
├── 02.Scripts/          // 공통 스크립트 (14개)
└── 03.Prefabs/          // 프리팹 및 에셋
```

### 팀 기여도 분포
| 팀원 | 스크립트 수 | 주요 영역 | 我的 기여 |
|------|------------|-----------|-----------|
| **이재은** | **15** | **전투 시스템 리드** | **100% 공격 시스템** |
| Hanul | 8 | 플레이어 & 카메라 | 게임 피드 |
| Hye | 12 | UI & 사운드 & 스테이지 관리 | 사용자 경험 & 오디오 |
| 공통 | 14 | GameManager & 몬스터 | 공유 시스템 |
